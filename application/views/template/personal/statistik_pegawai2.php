                ...
                <div class="" role="tabpanel" data-example-id="togglable-tabs">
                    <ul id="myTab" class="nav nav-tabs bar_tabs" role="tablist">
                        <li role="presentation" class="active"><a href="#tab_content1" id="home-tab" role="tab"
                                data-toggle="tab" aria-expanded="true">Pegawai PNS</a></li>
                        <li role="presentation" class=""><a href="#tab_content2" role="tab" id="profile-tab"
                                data-toggle="tab" aria-expanded="false">Pegawai NON PNSD</a></li>
                    </ul>
                    <!----------------------------------------- start Pegawai PNS ---------------------------------------------------->
                    <div id="myTabContent" class="tab-content">
                        <div role="tabpanel" class="tab-pane fade active in" id="tab_content1"
                            ...
                            <div class="x_content">
                                <form id="form-tampil-pns" class="form-horizontal form-label-left"
                                    ...
                                    <div class="col-xs-12 col-md-3">
                                        <button type="submit" id="tampilkan_pns" onclick="tampilkan();"
                            ...
                            <div class="x_content" id="load-pns">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <a href="" class="btn btn-default btn_tampil" data-toggle="modal"
                                        data-target="#elegantModalForm">Check Details</a>
                                </div>
                                    ...
                                    <table id="pegawai_telat" class="table table-striped table-bordered">
                                        ...
                                        <thead>
                                            ...
                                            <tr>
                                                ...
                                                <th width="60%">
                                                    <center>MUHAMMAD IRFAN ADRIANSYAH</center>
                                                </th>
                                                <th width="20%">
                                                    <center>4</center>
                                                </th>
                                            ...
                                            <tr>
                                                ...
                                                <th width="60%">
                                                    <center>RECKY MARDIANSYAH</center>
                                                </th>
                                                <th width="20%">
                                                    <center>3</center>
                                                </th>
                                ...
                                <div class="col-6 col-md-3">
                                    <label for="telat">TOP 5 Pegawai Tanpa Keterangan <i
                        ...
                        <div role="tabpanel" class="tab-pane fade" id="tab_content2" aria-labelledby="profile-tab">
                            ...
                            <div class="x_content" id="load"></div>
                            <div class="x_content">
                                <form id="form-tampil-tkk" class="form-horizontal form-label-left"
                                    onsubmit="return false;">
                                    <div class="col-xs-12 col-sm-12 col-md-1">
                                        <label class="control-label">Tahun</label>
                                    </div>
                                    ...
                                    <div class="col-xs-12 col-md-3">
                                        <button type="submit" id="tampilkan_tkk" onclick="tampilkan1();"
                                            class="btn btn-primary">Tampilkan</button>
                                    </div>
                                </form>
                            </div>
                            <div class="x_content">
                                ...
                                <div class="col-12 col-md-6">
                                    ...
                                    <a href="" class="btn btn-default btn_tampil" data-toggle="modal"
                                        data-target="#elegantModalForm1">Check Details</a>
                                </div>
                                <div class="col-6 col-md-3">
                                    <label for="telat">TOP 5 Pegawai Telat <i class="fa fa-star-o"></i></label>
                    ...
                    <div class="modal fade" id="elegantModalForm" tabindex="-1" role="dialog"
                                ...
                                <form id="form-edit" onsubmit="return false;">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            ...
                                            <button type="submit" id="print_pns2" onchange="Print_pns()"
                                                onclick="print_pns();" class="btn btn-default" style=""
                                                actived>Hadir</button>
                                            <button type="submit" id="print_pns2" onchange="Print_pns()"
                                                onclick="print_pns();" class="btn btn-default" style="">Telat</button>
                                            <button type="submit" id="print_pns2" onchange="Print_pns()"
                                                onclick="print_pns();" class="btn btn-default" style="">Izin</button>
                                            <button type="submit" id="print_pns2" onchange="Print_pns()"
                                                onclick="print_pns();" class="btn btn-default" style="">Sakit</button>
                                            <button type="submit" id="print_pns2" onchange="Print_pns()"
                                                onclick="print_pns();" class="btn btn-default" style="">Tanpa
                                                Keterangan</button>
                    ...
                    <div class="modal fade" id="elegantModalForm1" tabindex="-1" role="dialog"
                        aria-labelledby="myModalLabel" aria-hidden="true">
                        <div class="modal-dialog-md">
                            <div class="modal-content animated fadeIn">
                                <div class="modal-header">
                                ...
                                <form id="form-edit" onsubmit="return false;">
                                    <div class="modal-body">
                                        <div class="form-group">
                                            <input type="hidden" id="id-userid" name="id_useridx" value="">
                                            <button type="submit" id="print_pns2" onchange="Print_pns()"
                                                onclick="print_pns();" class="btn btn-default" style="">Hadir</button>
                                            <button type="submit" id="print_pns2" onchange="Print_pns()"
                                                onclick="print_pns();" class="btn btn-default" style="">Telat</button>
                                            <button type="submit" id="print_pns2" onchange="Print_pns()"
                                                onclick="print_pns();" class="btn btn-default" style="">Izin</button>
...
<script>
    ...
    $(document).ready(function () {
        $.ajax({
            url: "<?php echo base_url(); ?>index.php/PersonalController/get_pegawai_max_telat",
            type: "GET",
            data: {
            ...
            success: function (ajaxData) {
                ...
                if (result != 0) {
                    for (var i = 0; i < result.length; i++) {
                        var button1 = "<a href='#' class='btn-edit' data-iduserid='" + result[i][
                                'userid'
                            ] +
                            "' title='Edit' style='color:#1ABB9C;'><span class='fa fa-search fa-1x'></span></a>";

                        c.row.add([
                            "<center>" + [i + 1] + "</center>",
                            result[i]['nama_pegawai'],
                            "<center>" + result[i]['jumlah'] + "</center>",
                        ]).draw();
                    }
