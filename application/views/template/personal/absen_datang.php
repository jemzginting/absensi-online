            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                  <form id="demo-form2" method="POST" action="<?php echo site_url('PersonalController/submit_absen_datang'); ?>" data-parsley-validate class="form-horizontal form-label-left">
