            ...
            <div class="row">
              <div class="col-md-8 col-sm-8 col-xs-8">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    <form id="demo-form2" method="POST" action="<?php echo site_url('AdminController/submit_menu'); ?>" data-parsley-validate class="form-horizontal form-label-left">

                        <div class="form-group">
                          <label class="control-label col-md-3 col-sm-3 col-xs-12" for="id_user">Nama Menu<span class="required">*</span>
                          </label>
