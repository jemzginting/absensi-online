...
<div class="row">
    <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
            ...
            <div class="x_content">
                <form id="guru-form" method="POST" data-parsley-validate class="form-horizontal form-label-left">
        ...
        $.ajax({
            ...
            success: function() { //ketika kondisi berhasil melakukan request
                ...
                var objguru = [{
                        ...
                        desc: '(Senin-Kamis : 06.40 - 15.30.WIB & Jumat : 06.40 - 11.20.WIB)'
                    },
                    {
                        type: 'enam_hari',
                        title: 'Enam Hari Sekolah',
                        desc: '(Senin-Kamis : 06.40 - 14.30.WIB & Jumat-Sabtu : 06.40 - 11.20.WIB)'
                    },
                    {
                        type: 'double_shift',
                        title: 'Double Shift',
                        desc: '(Senin-Kamis : 10.00 - 17.10.WIB, Jumat : 13.00 - 17.10.WIB & Sabtu : 10.00 - 17.10.WIB)'
                    }
                ];
...
<script>
    $('#btn_add').click(function() {
        var insert_data = $('#guru-form').serialize();
        console.log(insert_data);
        $.ajax({
            url: "<?php echo base_url(); ?>index.php/PengelolaController/submit_guru",
            type: "POST",
            data: insert_data,
