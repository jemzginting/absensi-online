...
function get_all_daftar_opd_kegiatan_luar()
{
  var id_daftar_kegiatan_luar = $('#id_daftar_kegiatan_luar').val();
        $.ajax({
          
          url: "<?php echo base_url();?>index.php/AbsensiController/get_all_daftar_opd_kegiatan_luar",
             type: "POST",
...
get_all_daftar_opd_kegiatan_luar();

$('#datatable').on('click','.btn-edit', function(){
  var id_daftar_opd_kegiatan_luar = $(this).data("id_daftar_opd_kegiatan_luar");
  $.ajax({
    url: "<?php echo base_url();?>index.php/AbsensiController/get_daftar_opd_kegiatan_luar_by_id",
     type: "POST",
     data : {id_daftar_kegiatan_luar:id_daftar_kegiatan_luar,bulan:bulan,tahun:tahun},                   
        beforeSend:function(){  
