<div class="row" id="list">
  <div class="x_panel">
    <div class="x_title">
      <h2>Daftar OPD Kegiatan Luar</h2>
...
function get_opd_kegiatan_luar()
{
  ...
  // alert(id_daftar_kegiatan_luar);
        $.ajax({
          ...
          url: "<?php echo base_url();?>index.php/AbsensiController/get_opd_kegiatan_luar_by_id",
             type: "POST",
             ...
             {    
                  ...
                  {
                      var button1 = "<a href='#' class='btn-edit' data-sid='"+result[i]['id_daftar_opd_kegiatan_luar']+"' data-deptid='"+result[i]['DeptID']+"' title='Edit' style='color:#1ABB9C;'><span class='fa fa-search fa-1x'></span></a>";  
...
$('#datatable').on('click','.btn-edit', function(){
  ...
  $.ajax({
    url: "<?php echo base_url();?>index.php/AbsensiController/kehadiran_opd",
     type: "POST",
     data : {id_daftar_opd_kegiatan_luar:id_daftar_opd_kegiatan_luar,tanggal:tanggal,DeptID:DeptID},                   
        beforeSend:function(){  
