...
{
        $.ajax({
          url: "<?php echo site_url('AdminController/get_all_waktu')?>",
             type: "POST",
             data : null,                   
             ...
             {    
                  ...
                  {
                      var button1 = "<a href='#' class='btn-edit' data-did='"+result[i]['id_waktu']+"' title='Edit' style='color:#1ABB9C;'><span class='fa fa-edit fa-2x'></span></a>";
                      var button2 = "<a href='#' class='btn-hapus' data-did='"+result[i]['id_waktu']+"' title='Hapus' style='color:#BB1A1A;'><span class='fa fa-trash fa-2x'></span></a>";
                     
                       t.row.add( [
                              i+1,
                              result[i]['hari'],                              
                              result[i]['nilai_waktu'],                              
