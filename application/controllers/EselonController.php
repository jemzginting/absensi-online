...
class PersonalController extends CI_Controller {
	...
	{ 
		...
		$this->template->view('template/personal/main_content',3,$datacontent);
	}
	...
	public function list_absensi_pegawai()
	{
		...
		$this->template->view('template/personal/list_absensi_pegawai',3,$datacontent);
	}
	...
	public function daftar_jadwal_kegiatan_luar()
	{
		...
		$this->template->view('template/personal/daftar_jadwal_kegiatan_luar',3, $datacontent);
	}
	...
	public function submit_kehadiran()
	{
		...
		$this->template->view('template/personal/tambah_kehadiran',3,$data);
	}
	...
	public function kembali_kehadiran()
	{
		...
		$this->template->view('template/personal/kehadiran_opd',3,$data);
	}
	...
	public function kegiatan_luar()
	{
		...
		$this->template->view('template/personal/kegiatan_luar',3,$datacontent);
	}
	...
	public function rekap_absensi_bulanan()
	{
		...
		$this->template->view('template/personal/rekap_absensi_bulanan',3,$datacontent);
	}
		...
		$checkinout = $this->RekapModel->get_checkinout_by_tahun_bulan($data);
			...
			foreach ($res as $row) {
				...
				if($data['status_kepegawaian']=="pns"){
					...
					$data['tl'] = $tl1+$tl2+$tl3+$tl4+$tl5+$tl6;
...
//			$gg = Modules::run("appdok/pantau/kontrol",$id_pegawai);
	...
	public function list_jadwal_kegiatan_luar()
	{
		$session_data = $this->session->userdata('sess_personal');
		$datacontent['session'] = $session_data;
		$this->template->view('template/personal/list_jadwal_kegiatan_luar',3,$datacontent);
	}
	...
	public function list_staff()
	{
		...
		$this->template->view('template/personal/list_staff',3,$datacontent);
	}
