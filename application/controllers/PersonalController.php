...
class PersonalController extends CI_Controller
{
	...
	public function index()
	{
		...
		$this->template->view('template/personal/main_content', 4, $datacontent);
	}
	...
	public function get_statistik_pegawai_tahunan()
	{
		$session_data = $this->session->userdata('sess_personal');
		$datacontent['session'] = $session_data;
		$data['DeptID'] = $session_data['DeptID'];
		...
		$data['status'] = "pns";
		for ($i = 1; $i <= 12; $i++) {
			$statistik_tahunan = $this->LaporanModel->get_statistik_pegawai_tahunan($data, $i);
			$datacontent = $statistik_tahunan;
		}

		echo json_encode($statistik_tahunan);
	}
	...
	public function get_pegawai_telat_tanpaKeterangan()
	{
		$session_data = $this->session->userdata('sess_personal');
		$datacontent['session'] = $session_data;
		$data['DeptID'] = $session_data['DeptID'];
	...
	public function get_tkk_telat_tanpaKeterangan()
	{
		$session_data = $this->session->userdata('sess_personal');
		$datacontent['session'] = $session_data;
		$data['DeptID'] = $session_data['DeptID'];
		...
		$datacontent['banyak_telat'] = $this->LaporanModel->get_tkk_max_telat($data);
		$datacontent['banyak_tk'] = $this->LaporanModel->get_tkk_max_tk($data);
